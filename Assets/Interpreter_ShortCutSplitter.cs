...
public class Interpreter_ShortCutSplitter 
     : AbstractInterpreterMono
{
    ...
    {
        return (command.GetLine().ToLower().Trim().IndexOf("sc:") == 0);
    }

    public override string GetName()
    {
        return "Short Cut Splitter";
    }

    public override void TranslateToActionsWithStatus(ref ICommandLine command, ref ExecutionStatus succedToExecute)
    {
        throw new NotImplementedException("Need to be coded");
    }
